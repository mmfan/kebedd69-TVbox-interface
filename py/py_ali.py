    ...
    def login(self):
        ...
        if len(self.authorization) == 0 or self.timeoutTick - self.localTime <= 600:
            header = {
                ...
                "Referer": "https://ghproxy.com/https://raw.githubusercontent.com/kebedd69/TVbox-interface/main/token.json"
            }
            rsp = requests.post("https://ghproxy.com/https://raw.githubusercontent.com/kebedd69/TVbox-interface/main/token.json",headers=header)
            content = rsp.text
